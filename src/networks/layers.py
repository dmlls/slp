"""Layers for Progressive Transformer."""
...
class MultiHeadAttention(nn.Module):
    """Multi-head attention layer for a Progressive Transformer."""
...
class PositionWiseFeedForward(nn.Module):
    """"Position-wise feed-forward layer for a Progressive Transformer."""
...
class PositionalEncoding(nn.Module):
    """"Positional encoding layer for a Progressive Transformer."""
...
class TransformerEncoderLayer(nn.Module):
    """"Encoder layer for a Progressive Transformer."""
    ...
    def __init__(
        ...
        self.src_src_att = MultiHeadAttention(num_heads, size,
                                                dropout=dropout)
...
class TransformerDecoderLayer(nn.Module):
    """"Decoder layer for a Progressive Transformer."""
