...
class ConfigurationError(Exception):
    """Custom exception for incorrect specifications of configuration."""
...
def get_latest_checkpoint(ckpt_dir, post_fix="_every" ) -> Optional[str]:
    ...
    Returns the latest checkpoint (by time) from the given directory, of
    either every validation step or best If there is no checkpoint in this
